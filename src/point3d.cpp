...
struct point3d {
    ...
    bool operator==(point3d o) const { return x == o.x && y == o.y && z == o.z; }
    point3d operator+(point3d o) const { return point3d(x + o.x, y + o.y, z + o.z); }
    point3d operator-(point3d o) const { return point3d(x - o.x, y - o.y, z - o.z); }
    point3d operator*(T o) const { return point3d(x * o, y * o, z * o); }
    point3d operator/(T o) const { return point3d(x / o, y / o, z / o); }

    friend T dot(point3d a, point3d b) { return a.x * b.x + a.y * b.y + a.z * b.z; }
